...
from .cms import (
    ...
    PartnerListView,
    PartnerDetailView,
    PartnerLogoDeleteView,
    PartnerActivateView,
    PartnerDeactivateView,
    YoutubePlaylistListView,
    YoutubePlaylistDetailView,
    YoutubePlaylistActivateView,
    YoutubePlaylistDeactivateView,
    YoutubeChannelView,
    NewsSourceListView,
    ...
    GalleryAlbumActivateView,
    GalleryAlbumDeactivateView,
    GalleryListView,
    GalleryDetailView,
    GalleryActivateView,
...
urlpatterns = [
    ...
    *master_lookup_urls,
    ...
    path('partners/',                             PartnerListView.as_view(),         name='admin-partners-list'),
    path('partners/<int:pk>/',                    PartnerDetailView.as_view(),       name='admin-partners-detail'),
    path('partners/<int:pk>/logo/',               PartnerLogoDeleteView.as_view(),   name='admin-partners-logo-delete'),
    path('partners/<int:pk>/activate/',           PartnerActivateView.as_view(),     name='admin-partners-activate'),
    path('partners/<int:pk>/deactivate/',         PartnerDeactivateView.as_view(),   name='admin-partners-deactivate'),

    path('youtube-playlists/',                      YoutubePlaylistListView.as_view(),       name='admin-youtube-playlists-list'),
    path('youtube-playlists/channel/',              YoutubeChannelView.as_view(),            name='admin-youtube-channel'),
    path('youtube-playlists/<int:pk>/',             YoutubePlaylistDetailView.as_view(),     name='admin-youtube-playlists-detail'),
    path('youtube-playlists/<int:pk>/activate/',    YoutubePlaylistActivateView.as_view(),   name='admin-youtube-playlists-activate'),
    path('youtube-playlists/<int:pk>/deactivate/',  YoutubePlaylistDeactivateView.as_view(), name='admin-youtube-playlists-deactivate'),
    ...
    path('gallery/albums/',                          GalleryAlbumListView.as_view(),       name='admin-gallery-album-list'),
    path('gallery/albums/<int:pk>/',                 GalleryAlbumDetailView.as_view(),     name='admin-gallery-album-detail'),
    path('gallery/albums/<int:pk>/activate/',        GalleryAlbumActivateView.as_view(),   name='admin-gallery-album-activate'),
    path('gallery/albums/<int:pk>/deactivate/',      GalleryAlbumDeactivateView.as_view(), name='admin-gallery-album-deactivate'),
