...
def seed_gis_translations():
    ...
    screens = {
        ...
        'fpo_recommendations': {
            ...
            'offline_title':               ('Recommendation service is offline', 'ശുപാർശ സേവനം ഓഫ്‌ലൈനാണ്'),
            'offline_body':                ('We couldn\'t refresh your recommendation, so you are seeing your previous one. Please try again later.', 'നിങ്ങളുടെ ശുപാർശ പുതുക്കാൻ കഴിഞ്ഞില്ല, അതിനാൽ മുമ്പത്തെ ശുപാർശയാണ് കാണിക്കുന്നത്. ദയവായി പിന്നീട് വീണ്ടും ശ്രമിക്കുക.'),
            'offline_generated_on':        ('Previous recommendation generated on {date}.', 'മുമ്പത്തെ ശുപാർശ {date}-ന് തയ്യാറാക്കിയതാണ്.'),
            'offline_last_attempt':        ('Last refresh attempt: {date}.', 'അവസാന പുതുക്കൽ ശ്രമം: {date}.'),
        ...
        'fpo_gis': {
            ...
            'map_satellite_tooltip':     ('Switch to satellite view', 'സാറ്റലൈറ്റ് വ്യൂവിലേക്ക് മാറുക'),
            'map_street_tooltip':        ('Switch to street view', 'സ്ട്രീറ്റ് വ്യൂവിലേക്ക് മാറുക'),
            'map_roads_hide':            ('Hide roads', 'റോഡുകൾ മറയ്ക്കുക'),
            'map_roads_show':            ('Show roads', 'റോഡുകൾ കാണിക്കുക'),
            'map_labels_hide':           ('Hide place names', 'സ്ഥലപ്പേരുകൾ മറയ്ക്കുക'),
            'map_labels_show':           ('Show place names', 'സ്ഥലപ്പേരുകൾ കാണിക്കുക'),
            'preview_legend_boundary':   ('Farm boundary', 'കൃഷിയിടത്തിന്റെ അതിര്'),
            'preview_legend_location':   ('Farm location', 'കൃഷിയിടത്തിന്റെ സ്ഥാനം'),
            'search_placeholder':        ('Search a place…', 'ഒരു സ്ഥലം തിരയുക…'),
            'search_no_results':         ('No places found.', 'സ്ഥലങ്ങളൊന്നും കണ്ടെത്തിയില്ല.'),
            'search_searching':          ('Searching…', 'തിരയുന്നു…'),
