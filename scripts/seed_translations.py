...
def seed_frontend_ui_translations(languages):
    ...
    screens = {
        ...
        'admin_master_data': {
            ...
            'page_description': 'Manage the dropdown options used across the platform',
            'select_label': 'Master data table',
            'btn_add': 'Add',
            'category_commodity': 'Commodities',
            'category_promoting_agency': 'Promoting Agencies',
            'category_bank_name': 'Banks',
            'category_crop_name': 'Crop Names',
            'category_crop_group': 'Crop Groups',
            'code_placeholder_optional': 'Optional — generated from the name',
            'col_code': 'Code',
            'col_name': 'Name',
            'col_section': 'Section',
            'col_order': 'Order',
            ...
            'section_agricultural': 'Agricultural',
            'section_horticultural_fruits': 'Horticultural – Fruits',
            'section_horticultural_vegetables': 'Horticultural – Vegetables',
            'section_horticultural_tubers': 'Horticultural – Tubers',
            'section_value_added': 'Value Added',
            'action_edit': 'Edit',
            'action_activate': 'Activate',
            'action_deactivate': 'Deactivate',
            'action_delete': 'Delete',
            'delete_title': 'Delete Entry',
            'delete_description': 'Are you sure you want to delete "{name}"? This cannot be undone. Entries that are in use cannot be deleted — deactivate them instead.',
            'toast_created': 'Added',
            'toast_updated': 'Updated',
            'toast_activated': 'Activated',
            'toast_deactivated': 'Deactivated',
            'toast_deleted': 'Deleted',
            'toast_failed': 'Failed to save',
            'toast_delete_failed': 'Failed to delete',
            'add_title': 'Add',
            'edit_title': 'Edit',
            'code_label': 'Code',
            'code_placeholder': 'e.g. black_pepper',
            'code_locked_hint': 'The code cannot be changed — other records refer to it.',
            'name_en_label': 'Name (English)',
            'name_ml_label': 'Name (Malayalam)',
            'name_ml_placeholder': 'Optional — defaults to the English name',
...
#----------------------------------------------------------------------
        ...
        ('government_training_new',  'New Training Session',      'പുതിയ പരിശീലന സെഷൻ'),
        ('government_training_reports', 'Training Reports',           'പരിശീലന റിപ്പോർട്ടുകൾ'),
...
def seed_translations():
    ...
    # Step 9g: Market Linkage / Market Hub / Buyer portal (Arunima — P2-11, P2-12)
    # (marketplace + products-page translations are seeded in Step 4b/4c)
